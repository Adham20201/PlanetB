...
public class TwoColumnCourseAdapter extends RecyclerView.Adapter<TwoColumnCourseAdapter.ViewHolder>{

    private final CoursesInterface coursesInterface;
    ArrayList<Courses> topicCourse;
    Context context;

    public TwoColumnCourseAdapter(Context context, ArrayList<Courses> topicCourse, CoursesInterface coursesInterface){
    ...
    @NonNull
    @Override
    public TwoColumnCourseAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType ) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.cards_courses_2,parent,false);
        return new TwoColumnCourseAdapter.ViewHolder(view,coursesInterface, topicCourse);
    }

    @Override
    public void onBindViewHolder(@NonNull TwoColumnCourseAdapter.ViewHolder holder, int position) {
